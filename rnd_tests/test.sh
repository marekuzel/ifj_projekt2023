...
execTest "Default nil initialisation" "input/default_nil_init.swift" "output/default_nil_init.txt" 0 todo fix?
...
execTest "Comparison of strings" "input/rel_string.swift" "output/rel_string.txt" 0 tobe fixed in bottom up
execTest "Relational operators" "input/rel.swift" "output/rel.txt" 0 tobe fixed by scanner
...
execTest "Builtin conversion functions" "input/builtin_convert.swift" "output/builtin_convert.txt" 0 todo 
...
execTest "Init Double variable with int literal" "input/double_int_init.swift" "output/empty.txt" 0 todo fix
